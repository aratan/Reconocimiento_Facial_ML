...
function setup() {
  ...
  BotonArduino.class("BotonEntrenar btn btn-primary");

  var BotonRedboard = createButton("Redboard");
  BotonRedboard.class("BotonEntrenar btn");

  var BotonESP8266 = createButton("ESP8266");
  BotonESP8266.class("BotonEntrenar btn");

  var BotonESP32 = createButton("ESP32");
  BotonESP32.class("BotonEntrenar btn");

  var BotonNada = createButton("Nada");
  BotonNada.class("BotonEntrenar btn");
